...
class CountryDaoTest {
    ...
    @Test
    fun `test inserting single country`() =
        runBlocking {
    ...
    @Test
    fun `test inserting multiple countries (bulk insert)`() =
        runBlocking {
    ...
    @Test
    fun `test inserting duplicate countries (REPLACE strategy)`() =
        runBlocking {
    ...
    @Test
    fun `test verify inserted data integrity`() =
        runBlocking {
            val country =
                createTestCountry(
                    name = "United States",
    ...
    @Test
    fun `test getAllCountries with empty database`() =
        runBlocking {
    ...
    @Test
    fun `test getAllCountries with populated database`() =
        runBlocking {
    ...
    @Test
    fun `test getCountriesByContinent with valid continent`() =
        runBlocking {
            val testCountries = createTestCountries()
            countryDao.insertAll(testCountries)
    ...
    @Test
    fun `test getCountriesByContinent with non-existent continent`() =
        runBlocking {
            val testCountries = createTestCountries()
            countryDao.insertAll(testCountries)
    ...
    @Test
    fun `test getCountriesByContinent with null continent`() =
        runBlocking {
            val testCountries = createTestCountries()
            countryDao.insertAll(testCountries)
    ...
    @Test
    fun `test getCountriesByContinent with empty continent`() =
        runBlocking {
            val testCountries = createTestCountries()
            countryDao.insertAll(testCountries)
    ...
    @Test
    fun `test case-insensitive continent search`() =
        runBlocking {
            val testCountries = createTestCountries()
            countryDao.insertAll(testCountries)
    ...
    @Test
    fun `test getCountriesByContinent with partial match`() =
        runBlocking {
            val testCountries = createTestCountries()
            countryDao.insertAll(testCountries)
    ...
    @Test
    fun `test updateCapital with valid country ID`() =
        runBlocking {
    ...
    @Test
    fun `test updateCapital with non-existent country ID`() =
        runBlocking {
            val country = createTestCountry()
            countryDao.insertAll(listOf(country))
    ...
    @Test
    fun `test updateCapital with null capital`() =
        runBlocking {
            val country = createTestCountry(capital = listOf("Old Capital"))
            countryDao.insertAll(listOf(country))
    ...
    @Test
    fun `test updateCapital with multiple capitals`() =
        runBlocking {
            val country = createTestCountry(capital = listOf("Old Capital"))
            countryDao.insertAll(listOf(country))
    ...
    @Test
    fun `test updateCountry with complete country object`() =
        runBlocking {
    ...
    @Test
    fun `test updateCountry with modified fields`() =
        runBlocking {
            val country =
                createTestCountry(
                    name = "Test Country",
    ...
    @Test
    fun `test verify update return values`() =
        runBlocking {
            val country = createTestCountry()
            countryDao.insertAll(listOf(country))
    ...
    @Test
    fun `test deleting existing country`() =
        runBlocking {
            val country = createTestCountry()
            countryDao.insertAll(listOf(country))
    ...
    @Test
    fun `test deleting non-existent country`() =
        runBlocking {
    ...
    @Test
    fun `test verify database state after deletion`() =
        runBlocking {
            val countries = createTestCountries()
            countryDao.insertAll(countries)
    ...
    @Test
    fun `test deleting last country in database`() =
        runBlocking {
            val country = createTestCountry()
            countryDao.insertAll(listOf(country))
    ...
    @Test
    fun `test delete specific country from multiple`() =
        runBlocking {
            val countries = createTestCountries()
            countryDao.insertAll(countries)
    ...
    @Test
    fun `test insert, read, update, delete sequence`() =
        runBlocking {
            // Insert
    ...
    @Test
    fun `test complex integration with multiple operations`() =
        runBlocking {
    ...
    @Test
    fun `test insert with complex nested objects`() =
        runBlocking {
            val complexCountry =
                Country(
                    name =
    ...
    @Test
    fun `test update and read consistency`() =
        runBlocking {
